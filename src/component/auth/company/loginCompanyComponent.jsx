...
const LoginCompanyComponent = (props) => {
    const {passwordValue, passwordChange, emailValue, emailChange, onSubmit} = props
  return (
    <>
        <div className='container-fluid d-flex justify-content- align-items-center vh-100 text-start'>
            ...
            <div className='right w-50 me-5'>
                ...
                <h3 className='fw-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, quidem. Voluptas nesciunt, doloribus voluptatum id voluptate sed recusandae excepturi! Sint!</h3>
                <form className='form-group' onSubmit={onSubmit}>
                    <div className='d-flex flex-column mt-5'>
                        <label htmlFor="email">Email</label>
                        <input className='my-3 p-2' style={{opacity: '0.5'}} type="text" name='email' placeholder='Masukan alamat email' autoFocus value={emailValue} onChange={emailChange}/>
                    </div>
                    <div className='d-flex flex-column '>
                        <label htmlFor="password">Kata Sandi</label>
                        <input className='my-3 p-2' style={{opacity: '0.5'}} type="password" name='password' placeholder='Masukan kata sandi' value={passwordValue} onChange={passwordChange} autoFocus/>
                    </div>
                    ...
                    <h5 className='text-center mt-5'>Anda belum punya akun? <Link className='text-warning text-decoration-none'>Daftar Disini</Link></h5>
                </form>
            </div>
        </div>
    </>
