            ...
            <div className='right w-50 me-5'>
                ...
                <form className='form-group' onSubmit={onSubmit}>
                    ...
                    <div className='d-flex flex-column '>
                        ...
                        <input className='my-3 p-2' style={{opacity: '0.5'}} type="number" id='handphone' placeholder='Masukan kata sandi' value={handphoneValue} onChange={handphoneChange} autoFocus/>
                    </div>
                    <div className='d-flex flex-column '>
                    ...
                    <h5 className='text-center mt-5'>Anda sudah punya akun? <Link className='text-warning text-decoration-none'>Masuk Disini</Link></h5>
                </form>
            </div>
        </div>
    </>
