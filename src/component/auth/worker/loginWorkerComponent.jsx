...
// import { LoginWorker } from "../../../storage/actions/auth/loginWrokerAction";
import "./style.css";

const LoginWorkerComponent = (props) => {
  const { passwordValue, passwordChange, emailValue, emailChange, onSubmit } =
    props;
    ...
    <>
      <div className="container-fluid d-flex justify-content- align-items-center vh-100 text-start">
        <div className="left d-flex text-center justify-content-center align-items-center w-50">
          ...
          <img
            className="position-absolute"
            style={{ left: "200px", top: "159px" }}
            src={pewLogo2}
            alt="/"
          />
          <img
            className="position-absolute"
            style={{ left: "200px", top: "163px" }}
            src={pewLogo2}
            alt="/"
          />
          <p
            className="position-absolute text-white fw-semi-bold"
            style={{ left: "230px", top: "147px" }}
          >
            Peworld
          </p>
        ...
        <div className="right w-50 me-5">
          ...
          <h3 className="fw-light">
            ...
            quidem. Voluptas nesciunt, doloribus voluptatum id voluptate sed
            recusandae excepturi! Sint!
          </h3>
          <form className="form-group" onSubmit={onSubmit}>
            ...
            <Link className="text-decoration-none">
              <p className="text-end w-100 text-decoration-none text-black fs-5  fw-semi-bold">
                Lupa kata sandi?
              </p>
            </Link>
            <button
              className="border-0 w-100 p-3 bg-warning text-white fw-semi-bold "
              type="submit"
            >
              Masuk
            </button>
