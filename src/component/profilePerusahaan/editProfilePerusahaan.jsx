              ...
              <div className="card-body">
                ...
                <form action="/action_page.php">
                  <div className="mb-4 mt-3">
                    ...
                    <input type="text" className="form-control" id="nama perusahaan" placeholder="Masukan nama perusahan" name="nama perusahaan" />
                  </div>
                  <div className="mb-4 mt-3">
                    <label for="bidang">Bidang</label>
                    <input type="text" className="form-control" id="bidang" placeholder="Masukan bidang perusahaan ex : Financial" name="bidang" />
                  </div>
                  <div className="mb-4 mt-3">
                    <label for="provinsi">Provinsi</label>
                    <input type="text" className="form-control" id="provinsi" placeholder="Masukan Provinsi" name="provinsi" />
                  </div>

                  <div className="mb-4 mt-3">
                    <label for="kota">Kota</label>
                    <input type="text" className="form-control" id="kota" placeholder="Masukan kota" name="kota" />
                  </div>
                  ...
                  <div className="mb-4 mt-3">
                    ...
                    <input type="email" className="form-control" id="email perusahaan" placeholder="Masukan email Perusahaan" name="email perusahaan" />
                  </div>
                  <div className="mb-4 mt-3">
                    <label for="nomor telepon">Nomor Telepon</label>
                    <input type="number" className="form-control" id="nomor telepon" placeholder="Masukan nomor telepon" name="nomor telepon" />
                  </div>
                </form>
              </div>
            </div>
